...
Try {
	...
	[string]$appVersion = '24.0.0.186'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '12/22/2016'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action 'Install' -Path "install_flash_player_24_plugin.msi" -Parameters "REBOOT=ReallySuppress /QN" -PassThru
		...
		Copy-File -Path "$dirSupportFiles\mms.cfg" -Destination "$envSystem32Directory\Macromed\Flash"
		Copy-File -Path "$dirSupportFiles\mms.cfg" -Destination "$envWinDir\SysWOW64\Macromed\Flash"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Action 'Uninstall' -Path "install_flash_player_24_plugin.msi" -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBq4fBT5+Vnc/Dc
# O4z/yynYGGZIwd4mlV8Ymv3QjGHEbqCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIOjm
# OiB1e0IC02FMEJdDg+YAK9abQWQ1H9ajEnod77uBMA0GCSqGSIb3DQEBAQUABIIB
# AEl60N998ncadmbysFstuS34NborHnZzU7oHWxwMs48gA0wpALDnVuWgwT6zZ6rL
# a5blS41OJxsTgWUL/kxSSHtgfCGKYJq9wWlc5VLkZz74ZI412Okk7RnY4x95HNvf
# 9OuBWa8a0MfVjRnLbX4mxSE5qcNIOYaGnkX3qRQCei6McBcYv5HIHc9TbrE5C3We
# 5+x/hkpWhzr1c6lNQPDcMzTSPpw2VCocaWxUqR2NGZqxJaomfgeXAGEV1kasAUCr
# KIuw1m57wTOAdHe13K9uzBZfDmCo3IpkGv/ULzWTIc82eld/zZWAX5XWqWEUQvHO
# NuEMdwPEMPutvhUnnJAs96ihggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTYxMjIyMTU1NjA0WjAjBgkqhkiG9w0BCQQxFgQU
# P5MF06ZQRRzej8d3erYG/NZiw6owgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBABEA2ijezSkJHagqWnOGhLJ5YQPPtHsfzjFqsM2kxlhMsFqWYtPydjzX
# 1RodLctf5Z+o0fpUakkebHejbHQNoaF39E/1F3eck/Fv6y8g02n/SoSAaZqMUO8u
# nWmQM/DhkmR6zSXQFm4zJsTH3CSbLuGPB4TTKpycYM99OQFH0wkRsWgyH0clmUun
# ukOlxercf5+eqebPUygELVyM7xNb29E7hdviYVhwns+T0fnH/P6xL/xUuY6z+ajV
# JdcUDc+V2r4Tz45xze2p52qC43sEHIV0yb2lUvmozjvdIofcTr6clz3n+Tv0poH2
# O1/JsSHsbSFBpT1jkhOXVNm9irGfShk=
